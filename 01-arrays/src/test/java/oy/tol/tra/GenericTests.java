...
public class GenericTests {
   ...
   void sortTestInteger() {
      ...
      List<Integer> list = new ArrayList<>(Arrays.asList(testArray));
      Collections.sort(list);
      Integer[] correctlySortedArray = new Integer[list.size()];
      list.toArray(correctlySortedArray);
   ...
   void sortTestString() {
      ...
      Collections.sort(list);
      String[] correctlySortedArray = new String[list.size()];
      list.toArray(correctlySortedArray);
